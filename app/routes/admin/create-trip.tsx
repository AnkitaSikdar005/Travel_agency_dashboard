...
const CreateTrip = ({ loaderData }: Route.ComponentProps ) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
       e.preventDefault() // to prevant default behavior of browser i,e is page page loading
        setLoading(true);
       ...
       try {
        ...
        // console.log('formData', formData);
           ...
           if(result?.id) navigate(`/trips/${result.id}`)  // redirect to the trip detail page
